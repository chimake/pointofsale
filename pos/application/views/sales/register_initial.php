...
<div style= "display: <?php echo $mode == 'store_account_payment' ? 'none': 'block' ;?>" id="show_hide_grid_wrapper">
	...
	<a href="javascript: void(0);" class="btn btn-primary" id="show_grid"><?php echo "Show Item Grid";?></a>
	<a href="javascript: void(0);" class="btn btn-primary" id="hide_grid"><?php echo "Hide Item Grid";?></a>
</div>
