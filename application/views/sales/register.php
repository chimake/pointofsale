				...
				<div class="col-md-4 no-padd">
					<?php echo form_open("sales/change_mode",array('id'=>'mode_form', 'autocomplete'=> 'off')); ?>
						<label ><?php echo lang('sales_mode') ?>
							<?php echo form_dropdown('mode',$modes,$mode,'id="mode" class="form-control"'); ?>
						</label>
					</form>
							...
							<div id="make_payment">
								...
								<table id="make_payment_table" class="table">
									<tr id="mpt_top">
										...
										<td>
											<?php echo form_dropdown('payment_type',$payment_options,$this->config->item('default_payment_type'), 'id="payment_types" class="input-medium form-control"');?>
										</td>
									</tr>
									<tr id="mpt_bottom" >
